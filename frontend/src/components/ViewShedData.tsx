...
export default function ViewShedData() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 font-sans flex flex-col items-center justify-center">
      <div className="w-full max-w-6xl text-center space-y-6 bg-slate-900 border border-slate-800 p-8 sm:p-12 rounded-2xl shadow-lg">
        ...
        {/* Action Card inside View Data Dashboard */}
        <div className="bg-slate-800 border border-slate-700 p-6 rounded-2xl shadow-lg text-left my-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-400">view all machines data in shed2</p>
          </div>
          <div className="flex gap-4">
            <button
              onClick={() => navigate('/dashboard/view-data/lines')}
